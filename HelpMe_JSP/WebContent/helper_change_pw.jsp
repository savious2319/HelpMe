		...
		<!-- Main -->
			...
			<div class="row gtr-200">
					...
					<ul class="actions fit">
						...
						<li><a href="${pageContext.request.contextPath}/helper_change_pw.jsp?helperId=${param.helperId}" class="button primary fit">Security</a></li>
					</ul>
					</div>
			</div>
			</div>
...
$.ajax({
	url :contextPath+"/helper/HelperChangePasswordOk.he?password="
			+ password,
	type : 'get',
	dataType : 'text',
	success : function(data) {
		
		location.replace(contextPath+ "/helper_change_pw.jsp");
