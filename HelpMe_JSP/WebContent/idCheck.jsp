	...
	<body class="is-preload">
		...
		<!-- Main -->
			<section id="main" class="wrapper">
				...
				<div class="inner">
					<%-- FindIdAction으로부터 메세지 전달 --%>
					<p style="text-align:center; font-size:x-large; font-weight:bold;">${msg}</p>
								
					<input type="button" value="Back to find id" onclick="location.href='${pageContext.request.contextPath}/findId.jsp'" style="display:block; margin:0 auto;">
					<br>		
