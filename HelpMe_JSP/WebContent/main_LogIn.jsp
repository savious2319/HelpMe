		...
		<!-- Menu -->
			...
			<nav id="menu">
				<ul class="links">
					...
					<li><a href="${pageContext.request.contextPath}/main_LogIn.jsp?loginAs=${param.loginAs}">Home</a></li>
					<c:choose>
		...
		<!-- Banner -->
			<section id="banner">
				<div class="image" data-position="center right">
					<img src="${pageContext.request.contextPath}/images/HM_img_main2.png" alt="" />
				</div>
				<div class="inner">					
			...
			<article id="one" class="spotlight odd accent1">
				<div class="inner">
					<div class="image" data-position="top right">
						<img src="${pageContext.request.contextPath}/images/step1.png" alt="" />
					</div>
			...
			<article id="two" class="spotlight even accent2">
				<div class="inner">
					<div class="image" data-position="top left">
						<img src="${pageContext.request.contextPath}/images/step2.png" alt="" />
					</div>
					<h2>Everything<br />
					becomes<br />
					easy</h2>		
			...
			<div class="carousel">
				<article class="visible" style="">
					<div class="image" data-position="top center">
						<img id="step1_1" src="${pageContext.request.contextPath}/images/Kakao.png" alt="" />
						<img id="step1_2" src="${pageContext.request.contextPath}/images/Kakao.png" alt="" />
						<img id="step1_3" src="${pageContext.request.contextPath}/images/shopping.png" alt="" />
						<img id="step1_4" src="${pageContext.request.contextPath}/images/kakaotalk.png" alt="" />
						<img id="step1_5" src="${pageContext.request.contextPath}/images/Kakao.png" alt="" />
						<img id="step1_6" src="${pageContext.request.contextPath}/images/food.png" alt="" />
						<img id="step1_7" src="${pageContext.request.contextPath}/images/1.png" alt="" />
					</div>
				...
				<article style="display: none;" class="">
					<div class="image" data-position="center center">
						<img id="step2_1" src="${pageContext.request.contextPath}/images/Kakao.png" alt="" />
						<img id="step2_2" src="${pageContext.request.contextPath}/images/Kakao.png" alt="" />
						<img id="step2_3" src="${pageContext.request.contextPath}/images/Kakao.png" alt="" />
						<img id="step2_4" src="${pageContext.request.contextPath}/images/Kakao.png" alt="" />
						<img id="step2_5" src="${pageContext.request.contextPath}/images/Kakao.png" alt="" />
						<img id="step2_6" src="${pageContext.request.contextPath}/images/Kakao.png" alt="" />
						<img id="step2_7" src="${pageContext.request.contextPath}/images/Kakao.png" alt="" />
					</div>
					<div class="content">
				...
				<article style="display: none;" class="">
					<div class="image" data-position="center center">
						<img id="step2_1" src="${pageContext.request.contextPath}/images/step3.png" alt="" />
						<img id="step2_2" src="${pageContext.request.contextPath}/images/step3.png" alt="" />
						<img id="step2_3" src="${pageContext.request.contextPath}/images/step3.png" alt="" />
						<img id="step2_4" src="${pageContext.request.contextPath}/images/step3.png" alt="" />
						<img id="step2_5" src="${pageContext.request.contextPath}/images/step3.png" alt="" />
						<img id="step2_6" src="${pageContext.request.contextPath}/images/step3.png" alt="" />
						<img id="step2_7" src="${pageContext.request.contextPath}/images/step3.png" alt="" />
					</div>
					<div class="content">
			...
			<section class="wrapper">
				...
				<div class="inner">
					...
					<div class="posts" style="padding:30px;">
						<article  id="five">
							<a class="image"><img src="${pageContext.request.contextPath}/images/translation.png" alt="" /></a>
							<div class="content">
								<h3>Translation</h3>
						...
						<article>
							<a class="image"><img src="${pageContext.request.contextPath}/images/government service.png" alt="" /></a>
							<div class="content">
						...
						<article>
							<a class="image"><img src="${pageContext.request.contextPath}/images/tax accounting.png" alt="" /></a>
							<div class="content">
						...
						<article>
							<a class="image"><img src="${pageContext.request.contextPath}/images/hospitial.png" alt="" /></a>
							<div class="content">
								<h3>Hospitial</h3>
						...
						<article>
							<a class="image"><img src="${pageContext.request.contextPath}/images/travel.png" alt="" /></a>
							<div class="content">
								<h3>Travel</h3>
						...
						<article>
							<a class="image"><img src="${pageContext.request.contextPath}/images/housing.png" alt="" /></a>
							<div class="content">
								<h3>Housing</h3>
						...
						<article>
							<a class="image"><img src="${pageContext.request.contextPath}/images/shopping.png" alt="" /></a>
							<div class="content">
								<h3>Shopping</h3>
						...
						<article>
							<a class="image"><img src="${pageContext.request.contextPath}/images/food.png" alt="" /></a>
							<div class="content">
								<h3>Food</h3>
