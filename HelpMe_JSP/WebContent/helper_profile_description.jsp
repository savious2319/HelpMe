...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
	...
	<c:if test="${session_id eq null}">
		...
		<section id="main" class="wrapper alt" style="padding-top:2rem">
				...
				<c:set var="name" value="${requestScope.helperName}"/>	
				<c:set var="intro" value="${requestScope.helperIntro}"/>	
				<c:set var="description" value="${requestScope.helperDescription}"/>	
				<c:set var="pic" value="${requestScope.helperPic}"/>
				...
				<div class="col-6 col-12-medium" id="description">
					<img src="${pageContext.request.contextPath}/${pic}" class="profile_pic">
...
${description}
		...
		<!-- Scripts -->
			...
			<script src="${pageContext.request.contextPath}/helper_profile_description.js"></script>
