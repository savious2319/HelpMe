...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
   ...
   <%-- <c:if test="${session_id eq null}">
      <script>
         alert("Please post your review after logging in.");
         location.replace()는 히스토리에 남기지 않으므로 뒤로가기가 불가능하다.
   ...
   <c:choose>
      ...
      <!-- Main -->
      <%-- 후기 작성 부분 --%>
   <form action="${pageContext.request.contextPath}/BoardWriteOk.bo" method="post" enctype="multipart/form-data" id="boardForm" name="boardForm">
      ...
      <div class="table-wrapper" id="table-wrapper">
         <table class="alt">            
            <tbody>
               ...
               <tr align="center" valign="middle">
                  <td><div>Title</div></td>
                  <td><input name="board_title" id="board_title" type="text"></td>
               </tr>
               <tr align="center" valign="middle">
                  <td><div>Writer</div></td>
                  <td><input name="client_id" type="text"value="${session_id}" readonly /></td>         
               </tr>
               <tr height="214px">
         ...
         <div align="right">
            <a href="javascript:addboard()">[Post]</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   ...
   <!-- Footer -->
      ...
      function addboard(){
         ...
         //제목과 카테고리가 공란일 경우 후기를 등록할 수 없도록 설정.
         if(title==""||category==""){
