...
<c:if test="${session_id eq null}">
		...
		<!-- Header -->
			<header id="header">
				...
				<a href="${pageContext.request.contextPath}/main_Login.jsp"><img src="${pageContext.request.contextPath}/images/logo11_2.png" alt="" /></a>
				<nav>
					<ul>
						<li>
							<a href="#menu">Menu</a>
		...
		<section id="main" class="wrapper alt" style="padding-top:2rem">
				...
				<c:set var="education" value="${requestScope.helperEducation}"/>
				<c:set var="work" value="${requestScope.helperWork}"/>
				<c:set var="certificate" value="${requestScope.helperCertificate}"/>
				...
				<li>
					...
					<li>
						<input type="text" name="gradyear" id="gradyear" value="${education.getGraduate_year()}" readonly style="background-color:white" />
						</li>
				...
				<c:when test="${work != null and fn:length(work) > 1}">
					...
					<ul class="actions fit work" id="${work.getWork_experience()}" style="margin-bottom:0px">
				<li>
					<input type="text" name="position" id="position" value="${work.getWork_experience()}" readonly style="background-color:white" />		  
					</li>
					
					<li>
						<input type="text" name="startyear" id="startyear" value="${work.getWork_startyear()}" readonly style="background-color:white" />
						</li>
						
						
					<li>
						<input type="text" name="endyear" id="endyear" value="${work.getWork_endyear()}" readonly style="background-color:white" />
						</li>
						<c:set var="work" value="${work.getWork_experience()}"/>
						<li>
					<a href="javascript:deleteWork(`${work}`)" id="removeWork" class="button primary small" style="display:block">Remove</a>
						...
						<c:otherwise>
						<c:forEach var="work" items="${work}">
						<ul class="actions fit" id="${work.getWork_experience()}" style="margin-bottom:0px">
				<li>
					<input type="text" name="position" id="position" value="${work.getWork_experience()}" readonly style="background-color:white" />		  
					</li>
				...
				<h5 class="aboutheader"><b>Date Obtained</b></h5>
					...
					<c:choose>
					<c:when test="${certificate != null and fn:length(certificate) > 1}">
				...
				<li>
					...
					<li>
						<input type="text" name="date_obtained" id="date_obtained" value="${certificate.getDate_obtained()}" readonly style="background-color:white" />					
						</li>
					<c:set var="certificate" value="${certificate.getCertificate()}"/>
						
						<li>
					<a href="javascript:deleteCertificate(`${certificate}`)" id="removeCertificate" class="button primary small" style="display:block">Remove</a>
						</li>
						</ul>
		...
		<!-- Scripts -->
			...
			<script src="${pageContext.request.contextPath}/helper_profile_background.js"></script>
