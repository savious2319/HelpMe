...
<!-- 				<a class="logo" href="main_Default.jsp"><img src="images/logo_85x21.png"/></a> -->
										...
										<tbody id="schedule_body">
            								<c:if test="${day != null and fn:length(day) > 0}">
               								...
               								<tr class="schedule">
               									<td class="day">
               									<c:choose>
												      <c:when test="${helper.getAvailDay() == 2}">
												      	Monday
												      </c:when>
												        
												      <c:when test="${helper.getAvailDay() == 3}">
												      	Tuesday
												      </c:when>
												      
												      <c:when test="${helper.getAvailDay() == 4}">
												      	Wednesday
												      </c:when>
												      
												      <c:when test="${helper.getAvailDay() == 5}">
												      	Thursday
												      </c:when>
												      
												      <c:when test="${helper.getAvailDay() == 6}">
												      	Friday
												      </c:when>
												      
												      <c:when test="${helper.getAvailDay() == 7}">
												      	Saturday
												      </c:when>
												      
												      <c:when test="${helper.getAvailDay() == 1}">
												      	Sunday
												      </c:when>
												</c:choose>
												   </td>
		...
		<!-- Scripts -->
			...
			<script src="/helpme/resources/assets/js/schedule.js"></script>
