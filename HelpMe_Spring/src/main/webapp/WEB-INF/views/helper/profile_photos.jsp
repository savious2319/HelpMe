...
<c:if test="${session_id eq null}">
		...
		<div class="row gtr-200">
			<div class="col-6 col-12-medium"
				...
				<ul class="actions fit">
					<li><a href="/helpme/helper/schedule" class="button primary fit">My
							Schedule</a></li>
					<li><a href="/helpme/helper/about"
					...
					<div class="box">
						<div class="col-6 col-12-medium">
							...
							<div class="inner" id="photos">
								<img src="/helpme/resources/${main_pic}" id="main_pic"> 
								<img src="/helpme/resources/${pic1}" id="pic1">
								<img src="/helpme/resources/${pic2}" id="pic2">
								<img src="/helpme/resources/${pic3}" id="pic3"> 
								<img src="/helpme/resources/${pic4}" id="pic4"> 
								<img src="/helpme/resources/${pic5}" id="pic5">
	...
	<script src="/helpme/resources/assets/js/helper_profile_photos.js"></script>
	<script>
